      ...
      <?php include 'components/header.php'; ?>    
            ...
            <div class="section">
                <div class="col span_1_of_3">
                    <img class="home-img" src="images/<?php print $img1; ?>" alt="graphic design of a visual representation of sustainable agriculture and its benefits to the world">
                </div>
            ...
            <div class="section">
                <div class="col span_2_of_4">
                    <img class="home-img" src="images/<?php print $img2; ?>" alt="photo of growing sprouts">
                </div>
                <div class="col span_2_of_4 span-text">
                    <?php print $para6; ?><br>
                    <center><a href="courses.php"><button class="enrollButtons" >View Courses</button></a></center>
                </div>
            </div>
        <footer>
